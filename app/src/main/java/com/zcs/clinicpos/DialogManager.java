...
import static com.zcs.clinicpos.IntentHelper.createIntentForAmazonAppstore;
import static com.zcs.clinicpos.IntentHelper.createIntentForGooglePlay;
import static com.zcs.clinicpos.PreferenceHelper.setAgreeShowDialog;
import static com.zcs.clinicpos.PreferenceHelper.setRemindInterval;
import static com.zcs.clinicpos.UriHelper.getAmazonAppstore;
import static com.zcs.clinicpos.UriHelper.getGooglePlay;
import static com.zcs.clinicpos.UriHelper.isPackageExists;
import static com.zcs.clinicpos.Utils.getDialogBuilder;
...
final class Utils {
    ...
    private static int getDialogTheme() {
        return 0;//isLollipop() ? R.style.CustomLollipopDialogStyle : 0;
    }
